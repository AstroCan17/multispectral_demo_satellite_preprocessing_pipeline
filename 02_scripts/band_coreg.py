...
def run_algorithm(input_dict,save_path):
    ...
    name_10b = "colombus_registered_rgb_12b.tif"
    name_8b = "colombus_registered_rgb_8b.tif"
    ...
    if not os.path.exists(f"{save_path}/03_rgb/16b_images"):
        ...
        # cv2.imwrite(f"{integrator.save_path}/16b_images/colombus_registered_pan.tif", warped_pan)
    if not os.path.exists(f"{save_path}/03_rgb/8b_images"):
        ...
        # cv2.imwrite(f"{integrator.save_path}/8b_images/colombus_registered_pan_8b.tif", integrator.normalize_8bit(warped_pan))
